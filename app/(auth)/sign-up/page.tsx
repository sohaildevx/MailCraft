    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex items-center justify-between px-6 py-4 md:px-12 lg:px-20 border-b border-white/10">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <Link href="/sign-in" className="hidden md:block text-sm font-medium tracking-wider text-gray-500 hover:text-white transition-colors">
            SIGN IN
          </Link>
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-4 border-l-2 border-[#E8FF4D] pl-6">
              <p className="text-sm text-gray-300 leading-relaxed">
                ...
                formal investor update to a casual check-in with zero
                friction.&quot;
              </p>
              <div className="flex flex-col">
                <span className="text-sm font-bold text-white">Tom Andersen</span>
                <span className="text-xs text-gray-500">Head of Growth, Linear</span>
              </div>
            </div>
          </div>

          <div className="flex flex-col gap-3">
            {["Free forever plan", "No credit card required", "Instant access"].map((perk) => (
          ...
          <div className="w-full max-w-sm flex flex-col gap-8">
            ...
            <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <p className="md:hidden text-sm text-gray-500 text-center">
                ...
                <Link href="/sign-in" className="text-[#E8FF4D] hover:underline">
                  Login →
                </Link>
              </p>
            </form>
